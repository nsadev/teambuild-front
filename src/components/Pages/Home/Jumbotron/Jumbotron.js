    ...
    <div className="jumbo-container">
        ...
        <div className="jumbotron">
            ...
            <p className="jumbo-text jumbo">
                Are you ready to start open sourcing but lack participation? Are
                you looking for a team for a pet project? Do you want to gain
                experience working with teams from all over?
            </p>
            <div>
                <GetStartedButton />
            </div>
