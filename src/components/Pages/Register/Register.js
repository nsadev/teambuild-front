      ...
      <div className="template-container signin-container">
        <div className="register-window">
          ...
          <form className="signin-form">
            ...
            <label className="form-text-color form-text">First name</label>
            <input
              className="signin-input form-text-color"
              type="text"
              name="firstname"
            ...
            <label className="form-text-color form-text">Last name</label>
            <input
              className="signin-input form-text-color"
              type="text"
              name="lastname"
        ...
        <div>
            ...
            <div className="template-container signin-container" >
                    ...
                    <div className="register-window">
                        ...
                        <form className="signin-form">
                            <label className="form-text-color form-text">E-mail</label>
                            <input className="signin-input form-text-color" type="email"
                                   name="e-mail" id="email" onChange={emailChange}/>

                            <label className="form-text-color form-text" >First name</label>
                            <input className="signin-input form-text-color" type="text"
                                   name="firstname" id="firstname" onChange={firstnameChange}/>
                            ...
                            <label className="form-text-color form-text" >Confirm password</label>
                            <input className="signin-input form-text-color" type="password"
...
>>>>>>> fc3f188cb5093ff0dde41a049340524e7cbee50b
            </div>
          </form>
        </div>
      </div>
