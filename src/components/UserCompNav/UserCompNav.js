    ...
    return(
        <div>
            <div className={`userNav ${SignedIn === 0 && 'hidden'}`}>
                <div className="userNav__img-wrapper" onMouseEnter={() => userMouse(1)} onMouseLeave={() => userMouse(0)}>
                    <img className="userNav__img-wrapper__img" src={userImg} alt="user profile" onMouseEnter={() => userMouse(1)} />
                </div>
                <div className={`subMenu ${hover === 0 && 'hidden'}`} onMouseEnter={() => userMouse(1)} onMouseLeave={() => userMouse(0)}>
